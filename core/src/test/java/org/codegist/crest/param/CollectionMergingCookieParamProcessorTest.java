 ...
 */
public class CollectionMergingCookieParamProcessorTest {

    private final CollectionMergingCookieParamProcessor toTest = new CollectionMergingCookieParamProcessor("--");
    ...
    public void shouldProcessParamEncodingThem() throws Exception {
        ...
        assertEquals("Cookie", actual.get(0).getName());
        assertEquals("p1=v%2011--v%2012", actual.get(0).getValue());
    }
    ...
    public void shouldProcessParamIgnoringEncodingFlag() throws Exception {
        ...
        assertEquals(1, actual.size());
        assertEquals("Cookie", actual.get(0).getName());
        assertEquals("p1=v 11--v 12", actual.get(0).getValue());
    }
