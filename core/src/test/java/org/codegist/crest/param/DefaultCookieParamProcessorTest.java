 ...
 */
public class DefaultCookieParamProcessorTest {

    private final ParamProcessor toTest = DefaultCookieParamProcessor.INSTANCE;
    ...
    public void shouldProcessParamEncodingThem() throws Exception {
        ...
        assertEquals("p1=v%2011,p1=v%2012", actual.get(0).getValue());
    }
    ...
    public void shouldProcessParamIgnoringEncodingFlag() throws Exception {
        ...
        assertEquals(1, actual.size());
        assertEquals("Cookie", actual.get(0).getName());
        assertEquals("p1=v 11,p1=v 12", actual.get(0).getValue());
    }
