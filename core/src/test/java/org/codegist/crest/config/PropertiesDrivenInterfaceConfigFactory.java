...
//
//            InterfaceConfigBuilder ricb = new InterfaceConfigBuilder(interfaze, context.getProperties()).setIgnoreNullOrEmptyValues(true);
//            ricb    .setMethodsEndPoint(endPoint)
//                    .appendMethodsPath(getServiceProp(serviceAlias, "path"))
...
//                    .setMethodsEntityWriter(getServiceProp(serviceAlias, "body-writer"))
...
//                MethodConfigBuilder mcb = ricb.startMethodConfig(method).setIgnoreNullOrEmptyValues(true);
...
//                        }
//
//                        mcb.appendPath(getMethodProp(serviceAlias, methAlias, "path"))
...
//                    MethodParamConfigBuilder pcb = mcb.startParamConfig(i).setIgnoreNullOrEmptyValues(true);
//
...
//            }
//
//            return ricb.build(true, buildTemplates);
