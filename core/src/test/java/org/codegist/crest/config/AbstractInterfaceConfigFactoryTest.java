...
//    }
//
//    public static final DeserializerRegistry DESERIALIZER_REGISTRY = new DeserializerRegistry.Builder()
...
//                .build();
//
//    public static final CRestContext MOCK_CONTEXT = mock(CRestContext.class);static{
//        Map<String,Object> mockProperties = mock(Map.class);
//        when(mockProperties.get(DeserializerRegistry.class.getName())).thenReturn(DESERIALIZER_REGISTRY);
...
//    static {
//        try {
//            MINIMAL_EXPECTED_CONFIG = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, MOCK_CONTEXT.getProperties())
...
//    static {
//        try {
//            PARTIAL_EXPECTED_CONFIG = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, MOCK_CONTEXT.getProperties())
//                    .setEndPoint("http://localhost:8080")
//                    .setPath("/my-path")
...
//                    .setAccepts("mime2").setPath("/m1").setResponseHandler(new Stubs.ResponseHandler1()).endMethodConfig()
//                    .startMethodConfig(Interface.METH_m1S)
...
//    static {
//        try {
//            FULLY_EXPECTED_CONFIG = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, MOCK_CONTEXT.getProperties())
//                    .setEndPoint("http://localhost:8080")
//                    .setPath("/my-path")
