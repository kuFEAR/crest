...
//
//        InterfaceConfig CONFIG = new InterfaceConfigBuilder(Rest.class, null)
//                .setMethodsEndPoint("http://test-server:8080")
//                .appendMethodsPath("/path")
//                .setMethodsSocketTimeout(15l)
//                .setMethodsConnectionTimeout(10l)
//                .setEncoding("utf-8")
//                .startMethodConfig(AAA)
//                .appendPath("/aaa")
//                .startParamConfig(0).setName("a").endParamConfig()
//                .startParamConfig(1).setName("b").endParamConfig()
//                .endMethodConfig()
//                .startMethodConfig(BBB).appendPath("/bbb/{pa}")
...
//                .endMethodConfig()
//                .startMethodConfig(CCC).appendPath("/ccc/{a}")
//                .setHttpMethod("POST")
...
//                .endMethodConfig()
//                .startMethodConfig(DDD).appendPath("/ddd")
//                .setHttpMethod("POST")
