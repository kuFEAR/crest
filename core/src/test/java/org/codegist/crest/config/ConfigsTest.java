...
//    }
//
//    static final InterfaceConfig FULL_CONFIG = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class)
//            .setEndPoint("server")
//            .setPath("path")
//            .setEncoding("iso")
...
//            .addMethodsExtraFormParam("fp1", "fp1-val")
//            .addMethodsExtraFormParam("fp2", "fp2-val")
//            .addMethodsExtraHeaderParam("hp1", "hp1-val")
//            .addMethodsExtraHeaderParam("hp2", "hp2-val")
//            .addMethodsExtraPathParam("pp1", "pp1-val")
//            .addMethodsExtraPathParam("pp2", "pp2-val")
//            .addMethodsExtraQueryParam("qp1", "qp1-val")
//            .addMethodsExtraQueryParam("qp2", "qp2-val")
//            .startMethodConfig(TestInterface.T1)
//            .addExtraFormParam("fp2", "fp2-val-over")
//            .addExtraFormParam("fp3", "fp3-val")
//            .addExtraHeaderParam("hp0", "hp0-val")
//            .setPath("path2")
//            .setHttpMethod("GET")
...
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class, new HashMap<String, Object>(){{put(CRestProperty.CONFIG_PARAM_DEFAULT_NAME, "d");}})
//                .setEndPoint("server")
//                .build();
...
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class).setEndPoint("server").setParamsName("n").build();
//        InterfaceConfig override = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class).buildTemplate();
//        InterfaceConfig expected = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class).setEndPoint("server").setParamsName("n")
...
//        InterfaceConfig base = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class).setEndPoint("server").buildTemplate();
//        InterfaceConfig result = Configs.override(base, FULL_CONFIG);
//        InterfaceConfig expected = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class).setEndPoint("server")
//                .setPath("path")
//                .setMethodsSocketTimeout(1l)
//                .setMethodsConnectionTimeout(2l)
//                .setEncoding("iso")
...
//                .setMethodsResponseHandler(new Stubs.ResponseHandler1())
//                .startMethodConfig(TestInterface.T1)
//                .addExtraFormParam("fp1", "fp1-val")
//                .addExtraFormParam("fp2", "fp2-val-over")
//                .addExtraFormParam("fp3", "fp3-val")
//                .addExtraHeaderParam("hp0", "hp0-val")
//                .addExtraHeaderParam("hp1", "hp1-val")
//                .addExtraHeaderParam("hp2", "hp2-val")
//                .addExtraPathParam("pp1", "pp1-val")
//                .addExtraPathParam("pp2", "pp2-val")
//                .addExtraQueryParam("qp1", "qp1-val")
//                .addExtraQueryParam("qp2", "qp2-val")
//                .setPath("path2")
//                .setHttpMethod("GET")
//                .setConnectionTimeout(3l)
//                .setSocketTimeout(4l)
...
//
//        InterfaceConfig override = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class)
//                .setEndPoint("server2")
////                .setParamsDestination(Destination.URL)
//                .addMethodsExtraFormParam("fp1", "my-fp1-val")
//                .addMethodsExtraHeaderParam("hp2", "my-hp2-val")
//                .addMethodsExtraPathParam("pp3", "pp3-val")
//                .startMethodConfig(TestInterface.T1)
//                .setRequestInterceptor(new Stubs.RequestInterceptor3())
//                .setPath("path2bis")
//                .endMethodConfig()
...
//                .endMethodConfig()
//                .buildTemplate();
//        InterfaceConfig expected = new AbstractConfigBuilder.InterfaceConfigBuilder(TestInterface.class)
//                .setEndPoint("server2")
//                .setPath("path")
//                .setEncoding("iso")
//                .setGlobalInterceptor(new Stubs.RequestInterceptor1())
...
//                .setMethodsResponseHandler(new Stubs.ResponseHandler1())
//                .startMethodConfig(TestInterface.T1)
//                .addExtraFormParam("fp1", "my-fp1-val")
//                .addExtraFormParam("fp2", "fp2-val-over")
//                .addExtraFormParam("fp3", "fp3-val")
//                .addExtraHeaderParam("hp0", "hp0-val")
//                .addExtraHeaderParam("hp1", "hp1-val")
//                .addExtraHeaderParam("hp2", "my-hp2-val")
//                .addExtraPathParam("pp1", "pp1-val")
//                .addExtraPathParam("pp2", "pp2-val")
//                .addExtraPathParam("pp3", "pp3-val")
//                .addExtraQueryParam("qp1", "qp1-val")
//                .addExtraQueryParam("qp2", "qp2-val")
//                .setPath("path2bis")
//                .setHttpMethod("GET")
...
//        }
//
//        public void setDeserializers(Deserializer[] deserializers) {
