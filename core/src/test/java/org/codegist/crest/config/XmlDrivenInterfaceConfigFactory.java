...
//            InterfaceConfigBuilder icb = new InterfaceConfigBuilder(interfaze, context.getProperties()).setIgnoreNullOrEmptyValues(true)
//                    .setMethodsEndPoint(endPoint)
//                    .appendMethodsPath(getString(interfaceConfig, "path"))
...
//
//                MethodConfigBuilder mcb = icb.startMethodConfig(method).setIgnoreNullOrEmptyValues(true);
...
//                        }
//
//                        mcb.appendPath(getString(methodNode, "path"))
//                                .setEndPoint(getString(methodNode, "end-point"))
...
//            }
//
//            return icb.build(true, buildTemplates);
