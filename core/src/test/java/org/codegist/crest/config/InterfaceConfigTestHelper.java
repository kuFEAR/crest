...
//                continue;
//            }
//            assertEquals(testMsg, expMethCfg.getPathTemplate(), testMethCfg.getPathTemplate());
...
//
//            int expSize = expMethCfg.getDeserializers() == null ? 0 : expMethCfg.getDeserializers().length;
//            int testSize = testMethCfg.getDeserializers() == null ? 0 : testMethCfg.getDeserializers().length;
//            assertTrue(
//                    (expMethCfg.getDeserializers() == null && testMethCfg.getDeserializers() == null)
//                            || (expMethCfg.getDeserializers() != null && testMethCfg.getDeserializers() != null && expSize == testSize)
//            );
//            if(expMethCfg.getDeserializers() != null && testMethCfg.getDeserializers() != null) {
//                for(int i = 0; i < expMethCfg.getDeserializers().length; i++){
//                    assertEquals(testMsg, TestUtils.getClass(expMethCfg.getDeserializers()[i]), TestUtils.getClass(testMethCfg.getDeserializers()[i]));
//                }
//            }
//
//
//
//            expSize = expMethCfg.getExtraParams() == null ? 0 : expMethCfg.getExtraParams().length;
//            testSize = testMethCfg.getExtraParams() == null ? 0 : testMethCfg.getExtraParams().length;
//            assertTrue(
//                    (expMethCfg.getExtraParams() == null && testMethCfg.getExtraParams() == null)
//                            || (expMethCfg.getExtraParams() != null && testMethCfg.getExtraParams() != null && expSize == testSize)
//            );
