...
//
//    private static final DeserializerRegistry REGISTRY = AbstractInterfaceConfigFactoryTest.DESERIALIZER_REGISTRY;
//
//    @Test
//    public void testAcceptHeader() {
//
//        Map<String, Object> map = new HashMap<String, Object>();
//        map.put(DeserializerRegistry.class.getName(), REGISTRY);
//        InterfaceConfig cfg = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, map)
//                .setEndPoint("d")
//                .setParamsName("q")
//                .setMethodsAccepts("mime1","mime2")
//                .build();
//
...
//                if (p.getDestination().equals("header") && p.getName().equals("Accept") && p.getDefaultValue().equals("mime1,mime2")) {
//                    found = true;
//                    break;
//                }
//            }
...
//        try {
//            new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("d").setPath("/fdf?dd").setParamsName("q").build();
//            fail("shoud have failed");
//        } catch (Exception e) {
//        }
//        try {
//            new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("d").setPath("/fdf?").setParamsName("q").build();
//            fail("shoud have failed");
//        } catch (Exception e) {
//        }
//        try {
//            new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("d").setPath("/fdf").setMethodsPath("/sd/sd?").setParamsName("q").build();
//            fail("shoud have failed");
//        } catch (Exception e) {
//        }
//        try {
//            new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("d").setPath("/fdf").setMethodsPath("/sd/sd?df").setParamsName("q").build();
//            fail("shoud have failed");
//        } catch (Exception e) {
//        }
//        new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("d").setPath("/fdf").setMethodsPath("/sd/sd").setParamsName("q").build();
...
//        AbstractConfigBuilder cb = new AbstractConfigBuilder(new HashMap<String, Object>()) {
//        };
...
//                cb.replacePlaceholders("http://{my.end-point.server}:{my.end-point.port}/bla/bla/{my.end-point.server}/bla"));
//
//        cb = new AbstractConfigBuilder(null) {
//        };
//        assertEquals("http://my.end-point.server:my.end-point.port/bla/bla/my.end-point.server/bla",
//                cb.replacePlaceholders("http://my.end-point.server:my.end-point.port/bla/bla/my.end-point.server/bla"));
//        assertEquals("http://{my.end-point.server}:{my.end-point.port}/bla/bla/{my.end-point.server}/bla",
...
//        InterfaceConfig b = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class)
//                .setEndPoint("d")
...
//            });
//        }};
//        InterfaceConfig b = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, props)
//                .setEndPoint("d")
//                .addMethodsExtraFormParam("ddd", "bbb")
//                .startMethodConfig(Interface.B)
//                .startParamConfig(0).setName("a").endParamConfig()
...
//        placeholders.put("my.place.holder.meth-consumes", "mime1");
...
//                            new Deserializer[]{new Stubs.Deserializer1()},
...
//                                    )
//                            },
//                            new ParamConfig[]{new DefaultParamConfig("Accept", "mime1", "header")}
//                    ));
...
//        );
//
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, props)
...
//                .setMethodsAccepts("{my.place.holder.meth-consumes}")
...
//        defaultOverrides.put(CONFIG_METHOD_DEFAULT_DESERIALIZERS, new Stubs.Deserializer1());
...
//        defaultOverrides.put(DeserializerRegistry.class.getName(), REGISTRY);
//        InterfaceConfig expected = new DefaultInterfaceConfig(
//                Interface.class,
//                "http://server:8080",
...
//                }}
//        );
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, defaultOverrides).setEndPoint("http://server:8080").build();
//        InterfaceConfigTestHelper.assertExpected(expected, config, Interface.class);
//    }
//
//    @Test
...
//                            TestUtils.newInstance(DEFAULT_DESERIALIZERS),
//                            new MethodParamConfig[]{
//                                    new DefaultMethodParamConfig(
//                                            "n",
//                                            DEFAULT_VALUE,
...
//                }}
//        );
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).setEndPoint("http://server:8080").setParamsName("n").build();
//        InterfaceConfigTestHelper.assertExpected(expected, config, Interface.class);
//    }
//
//    @Test
...
//                            new Deserializer[]{new Stubs.Deserializer2()},
//                            new MethodParamConfig[]{
//                                    new DefaultMethodParamConfig(
//                                            "n",
//                                            DEFAULT_VALUE,
...
//        );
//        Map<String, Object> props = new HashMap<String, Object>() {{
//            put(DeserializerRegistry.class.getName(), REGISTRY);
//        }};
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, props)
...
//            put(DeserializerRegistry.class.getName(), REGISTRY);
//        }};
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class, props).setEndPoint("http://server:8080").setParamsName("n")
//                .setMethodsPath("/test")
//                .addMethodsExtraParam("1", "2", HttpRequest.DEST_FORM)
//                .setMethodsHttpMethod("DELETE")
//                .setMethodsSocketTimeout(10l)
...
//                }}
//        );
//        InterfaceConfig config = new AbstractConfigBuilder.InterfaceConfigBuilder(Interface.class).buildTemplate();
//        InterfaceConfigTestHelper.assertExpected(expected, config, Interface.class);
//    }
//
//
