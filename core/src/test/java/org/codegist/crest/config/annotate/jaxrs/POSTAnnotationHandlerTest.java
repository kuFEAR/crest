 ...
 */
public class POSTAnnotationHandlerTest extends MethodOnlyAnnotationBaseTest<POST> {
    public POSTAnnotationHandlerTest() {
        super(POST.class, new POSTAnnotationHandler());
    }

    @Test
    public void handleMethodAnnotationShouldSetMethodTypeToPOST() throws Exception {
