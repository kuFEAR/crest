 ...
 */
public class CookieParamAnnotationHandlerTest extends AnnotationBaseTest<CookieParam> {
    ...
    public void handleInterfaceAnnotationShouldSetParamsTypeAndNameAndDefaultValue() throws Exception {
        ...
        verify(mockParamConfigBuilder).setType(ParamType.COOKIE);
    ...
    public void handleParameterAnnotationShouldSetTypeAndNameAndDefaultValue() throws Exception {
        ...
        verify(super.mockParamConfigBuilder).setType(ParamType.COOKIE);
