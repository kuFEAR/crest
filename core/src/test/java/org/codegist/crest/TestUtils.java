...
//
//
//    public static <T.xml> T.xml[] newInstance(Class<T.xml>[] classes) {
//        if (classes == null) return null;
//        try {
//            T.xml[] instances = (T.xml[]) java.lang.reflect.Array.newInstance(classes.getClass().getComponentType(), classes.length);
...
//        }
//    }
//    public static <T.xml> T.xml newInstance(Class<T.xml> clazz){
