 ...
 */
public class CharacterWrapperDeserializerTest extends BaseDeserializerTest {

    private final TypeDeserializer<Character> toTest = new CharacterWrapperDeserializer();
