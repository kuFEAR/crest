 ...
 */
public class CharacterPrimitiveDeserializerTest extends BaseDeserializerTest {

    private final TypeDeserializer<Character> toTest = new CharacterPrimitiveDeserializer();
