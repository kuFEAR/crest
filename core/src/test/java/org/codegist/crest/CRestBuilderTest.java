...
//            public Map<String, Object> getProperties() {
//                return new HashMap<String, Object>() {{
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_DESERIALIZERS, new Stubs.Deserializer1());
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_EXTRA_PARAMS, new ParamConfig[]{
//                            new ConfigBuilder.ParamConfigBuilder(null)
//                            .setName("Accept")
...
//            public Map<String, Object> getProperties() {
//                return new HashMap<String, Object>() {{
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_DESERIALIZERS, new JacksonDeserializer(mock(ObjectMapper.class)));
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_EXTRA_PARAMS, new ParamConfig[]{
//                            new ConfigBuilder.ParamConfigBuilder(null)
//                            .setName("Accept")
...
//            public Map<String, Object> getProperties() {
//                return new HashMap<String, Object>() {{
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_DESERIALIZERS, new JaxbDeserializer(mock(JAXBContext.class)));
//                    put(CRestProperty.CONFIG_METHOD_DEFAULT_EXTRA_PARAMS, new ParamConfig[]{
//                            new ConfigBuilder.ParamConfigBuilder(null)
//                            .setName("Accept")
...
//            DeserializerRegistry registry = new DeserializerRegistry.Builder().build();
