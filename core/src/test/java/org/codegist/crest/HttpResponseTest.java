...
//        assertEquals("text/javascript", res.getContentType());
...
////        HttpResponse res = buildResponseForStream("charset=utf-8");   TODO are these test relevant ??
////        assertEquals(Charset.forName("utf-8"), res.getCharset());
...
////        assertEquals("text/html", res.getMimeType());
//
//        HttpResponse res = buildResponseForStream("text/javascript; charset=utf-8");
//        assertEquals(Charset.forName("utf-8"), res.getCharset());
//        assertEquals("text/javascript", res.getContentType());
//
...
//        assertEquals("text/javascript", res.getContentType());
//
////        res = buildResponseForStream("charset=ISO-8859-1"); TODO are these test relevant ??
...
//        HttpResponse response = buildResponseForStream(original.getBytes("utf-8"), "text/plain;charset=utf-8");
...
//        String original = "hello world£";
//        HttpResponse response = buildResponseForStream(original.getBytes("ISO-8859-1"), "text/plain;charset=ISO-8859-1");
//        String data = IOs.toString(response.asStream(), response.getCharset());
//        assertEquals(original, data);
//    }
//
...
//        String original = "hello world£";
//        HttpResponse response = buildResponseForStream(original.getBytes("ISO-8859-1"), "text/plain");
//        String data = IOs.toString(response.asStream(), response.getCharset());
//        assertEquals(original, data);
//    }
//
...
//        String original = "hello world£";
//        HttpResponse response = buildResponseForStream(original.getBytes("ISO-8859-1"), "text/plain;charset=utf-8");
//        String data = IOs.toString(response.asStream(), response.getCharset());
...
//        String original = "hello world£";
//        HttpResponse response = buildResponseForStream(original.getBytes("utf-8"), "text/plain;charset=ISO-8859-1");
//        String data = IOs.toString(response.asStream(), response.getCharset());
//        assertFalse(original.equals(data));
//    }
//
...
//        String original = "hello world£";
//        HttpResponse response = buildResponseForStream(original.getBytes("utf-8"), "text/plain");
//        String data = IOs.toString(response.asStream(), response.getCharset());
//        assertFalse(original.equals(data));
//    }
//
