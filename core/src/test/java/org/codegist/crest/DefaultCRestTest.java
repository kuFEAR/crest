...
//    final String c2 = "c/c";
//
//    private static final DeserializerRegistry DESERIALIZER_REGISTRY = new DeserializerRegistry.Builder()
//            .register(new Stubs.Deserializer1(), "mime1").build();
//    static {
//        Deserializer d = mock(Deserializer.class);
//        when(d.<Object>deserialize(any(Type.class), any(InputStream.class), any(Charset.class))).thenReturn(MODEL_RESPONSE);
//    }
//    private ProxyFactory mockProxyFactory = TestUtils.mockProxyFactory();
//    private Map<String,Object> MOCK_PROPS= new HashMap<String, Object>(){{
//        put(DeserializerRegistry.class.getName(), DESERIALIZER_REGISTRY);
//    }};
//
//    @Test
...
//                assertEquals(expected, r.getUrl().toString());
//                return true;
//            }
...
//                                new ConfigBuilder.InterfaceConfigBuilder(RetryTest.class).setEndPoint("http://test.com")
...
//                mockRestService,
//                mockProxyFactory,
//                new PreconfiguredInterfaceConfigFactory(new ConfigBuilder.InterfaceConfigBuilder(ModelInterface.class, MOCK_PROPS).setEndPoint("http://test.com").setMethodsAccepts("mime").build()),
//                null
//        ));
...
//        Reader testReader();
//
//        InterfaceConfig CONFIG = new ConfigBuilder.InterfaceConfigBuilder(RawInterface.class).setEndPoint("http://test.com").build();
//    }
//
//
...
//                    assertEquals("http://test-server:8080/path/aaa", r.getUrl().toString());
...
//                    assertEquals("GET", r.getMeth());
//                    assertEquals("http://test-server:8080/path/bbb/c/c", r.getUrl().toString());
//                    assertEquals(0, r.getFormParams().size());
//                    assertEquals(2, r.getQueryParams().size());
...
//                    assertEquals("http://test-server:8080/path/ccc/100", r.getUrl().toString());
...
//                    assertEquals(10, r.getConnectionTimeout().intValue());
//                    assertEquals("POST", r.getMeth());
//                    assertEquals("http://test-server:8080/path/ddd", r.getUrl().toString());
//                    assertEquals(1, r.getQueryParams().size());
...
//        });
//
//        InterfaceConfig CONFIG = new ConfigBuilder.InterfaceConfigBuilder(Rest.class, MOCK_PROPS)
//                .setEndPoint("http://test-server:8080")
//                .setPath("/path")
//                .setMethodsSocketTimeout(15l)
//                .setMethodsConnectionTimeout(10l)
//                .setEncoding("utf-8")
//                .setMethodsAccepts("mime")
