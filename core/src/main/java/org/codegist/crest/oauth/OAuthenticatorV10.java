...
public class OAuthenticatorV10 implements OAuthenticator {
    public void sign(Token accessToken, HttpRequest.Builder request, HttpParam... extraAuthHeaders) {
    ...
    public Token refreshAccessToken(Token accessToken, String... includeExtras) {
        return null;
    }
...
//
//        this.entityWriter = new UrlEncodedFormEntityWriter();
...
//        else
//            requestTokenMeth = HttpMethod.POST.name();
//
...
//        else
//            accessTokenMeth =  HttpMethod.POST.name();
//
...
//        else
//            refreshAccessTokenMeth =  HttpMethod.POST.name();
//
...
//                request.addParam(param.getName(), param.getValue().asString(), dest, param.getValue().isEncoded());
//            }
...
//                request.addParam(p.getName(), p.getValue().asString(), HttpRequest.DEST_QUERY, p.getValue().isEncoded()); // TODO this isEncoded must be carefully checked all over the place!!
//            }
//        }
//    }
//
