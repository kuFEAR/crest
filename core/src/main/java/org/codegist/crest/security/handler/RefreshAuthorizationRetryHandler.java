...
public class RefreshAuthorizationRetryHandler implements RetryHandler {
    ...
    public RefreshAuthorizationRetryHandler(Map<String, Object> customProperties) {
        this.max = Numbers.parse((String) customProperties.get(CRestProperty.HANDLER_RETRY_MAX_ATTEMPTS), DEFAULT_MAX_ATTEMPTS);
        authorization = (Authorization) customProperties.get(Authorization.class.getName());
