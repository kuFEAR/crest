...
public class HttpResponse implements Response, Disposable {
    ...
    public HttpResponse(DeserializationManager deserializationManager, HttpRequest httpRequest, HttpResource resource) throws IOException {
    ...
    public Type getExpectedGenericType() {
        return httpRequest.getMethodConfig().getMethod().getGenericReturnType();
    }

    public Class<?> getExpectedType() {
        return httpRequest.getMethodConfig().getMethod().getReturnType();
    }
