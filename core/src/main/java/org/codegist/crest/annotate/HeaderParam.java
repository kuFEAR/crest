...
/**
 * <p>Binds a method parameter to be used as a request HTTP header.</p>
 ...
 * <p>When set at interface or method levels, it will add a HTTP header with the given value for all method's to which it applies</p>
...
public @interface HeaderParam {
    ...
    /**
     * Defines the name of the request HTTP header that will hold the given value
     */
    String value();

    /**
     * Defines the default value of the HTTP header if the value being passed is null
     */
