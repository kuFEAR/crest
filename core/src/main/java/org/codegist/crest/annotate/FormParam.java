...
/**
 * <p>Binds a method parameter to be used as a request form parameter.</p>
...
public @interface FormParam {
    ...
    /**
     * Defines the name of the request form parameter that will hold the given value
     */
    String value();

    /**
     * Defines the default value of the form parameter if the value being passed is null
     */
