...
class FormParamsAnnotationHandler extends NoOpAnnotationHandler<FormParams> {
    ...
    public FormParamsAnnotationHandler(FormParamAnnotationHandler handler) {
    ...
    @Override
    public void handleInterfaceAnnotation(FormParams annotation, InterfaceConfigBuilder builder) {
        for(FormParam paramAnnotation : annotation.value()){
            handler.handleInterfaceAnnotation(paramAnnotation, builder);
        }
    }

    @Override
    public void handleMethodAnnotation(FormParams annotation, MethodConfigBuilder builder) {
        for(FormParam paramAnnotation : annotation.value()){
