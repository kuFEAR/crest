...
package org.codegist.crest.impl.io.entity;
...
import static org.codegist.crest.impl.io.HttpParamType.FORM;
...
public class UrlEncodedFormEntityWriter implements EntityWriter {
    ...
    public void writeTo(Request request, OutputStream out) throws IOException {
        ...
        join(writer, iterate(request.getParams(FORM.name()), charset), '&');
        writer.flush();
    }
