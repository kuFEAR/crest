...
class DefaultMethodConfig implements MethodConfig {
    ...
    DefaultMethodConfig(Charset charset, Method method, PathTemplate path, String contentType, String accept, String type, int socketTimeout, int connectionTimeout, EntityWriter entityWriter, RequestInterceptor requestInterceptor, ResponseHandler responseHandler, ErrorHandler errorHandler, RetryHandler retryHandler, Deserializer[] deserializers, ParamConfig[] methodParamConfigs, ParamConfig[] extraParams) {
