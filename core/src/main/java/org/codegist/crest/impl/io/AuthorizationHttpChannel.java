...
public class AuthorizationHttpChannel implements HttpChannel {
    ...
    public AuthorizationHttpChannel(HttpChannel delegate, Authorization authenticatorManager, HttpMethod method, String url, Charset charset, Map<String, EntityParamExtractor> httpEntityParamExtrator) throws UnsupportedEncodingException {
        this.url = url;
        this.method = method;
    ...
    private void authenticate() throws IOException {
        ...
        try {
            token = authenticatorManager.authorize(method.name(), url, arrify(parameters, EncodedPair.class));
        } catch (Exception e) {
