...
package org.codegist.crest.impl.security.oauth.v1;
...
import org.codegist.crest.impl.io.HttpRequestBuilderFactory;
import org.codegist.crest.impl.io.HttpRequestExecutor;
import org.codegist.crest.io.RequestExecutor;
import org.codegist.crest.security.oauth.OAuthToken;
import org.codegist.crest.security.oauth.v1.*;
...
import static org.codegist.crest.impl.io.HttpMethod.POST;
...
public final class OAuthApiV1Builder {
    ...
    public static OAuthApiV1 build(HttpChannelInitiator channelInitiator, Map<String, Object> crestProperties, OAuthenticatorV1 oAuthenticatorV1) throws Exception {
        HttpMethod method = HttpMethod.valueOf(get(crestProperties, CONFIG_OAUTH_METHOD, POST.name()));
        ...
        Class<? extends OAuthInterface> oauthInterfaceCls = method.equals(HttpMethod.POST) ? PostOAuthInterface.class : GetOAuthInterface.class;
