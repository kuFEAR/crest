...
class DefaultParamConfig implements ParamConfig {
    ...
    DefaultParamConfig(Type type, Class<?> clazz, String name, String defaultValue, String paramType, Map<String,Object> metadatas, Serializer serializer, boolean encoded, ParamProcessor paramProcessor) {
