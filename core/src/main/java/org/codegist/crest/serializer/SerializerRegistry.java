 ...
 */
public final class SerializerRegistry extends Registry<Serializer>{

    private static final Serializer TOSTRING_SERIALIZER = new ToStringSerializer();

    private SerializerRegistry(Map<String, Object> mimeTypeRegistry, Map<String,Object> customProperties) {
        super(Serializer.class, mimeTypeRegistry, customProperties);
    }

    public static class Builder extends Registry.Builder<Serializer> {
        @Override
        public SerializerRegistry build(Map<String, Object> customProperties) {
            return new SerializerRegistry(mimeTypeRegistry, customProperties);
        }
    }
  ...
  /**
     ...
     */
    public Serializer getForType(Type type) {
