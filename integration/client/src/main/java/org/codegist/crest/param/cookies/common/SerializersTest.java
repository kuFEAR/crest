...
//        this test at least the the serialization process is executed for cookies as well
        assertEquals("default() p1=Data{val1=123, val2='val-456'} p2=AnotherBuchOfData(val1=31/12/2010 00:00:00, val2=false, val3=Data(val1=456, val2=val-789)),p2=AnotherBuchOfData(val1=20/01/2010 00:00:00, val2=false, val3=Data(val1=789, val2=val-123)) p3=AnotherBuchOfData(val1=02/12/2010 00:00:00, val2=true, val3=Data(val1=1456, val2=val-1789)),p3=AnotherBuchOfData(val1=23/03/2010 00:00:00, val2=true, val3=Data(val1=1789, val2=val-1123))", actual);
    }
...
//        these value doesn't mean anything, because the serialization generate cookies special characters (coma and semi-colon).
//        this test at least the the serialization process is executed for cookies as well
        assertEquals("configured() p1=Data(val1=123,val2=val-456) p2=MyBuchOfData(val1=31/12/2010 00:00:00,val2=false,val3=Data(val1=456,val2=val-789)),p2=MyBuchOfData(val1=20/01/2010 00:00:00,val2=false,val3=Data(val1=789,val2=val-123)) p3=MyBuchOfData(val1=02/12/2010 00:00:00,val2=true,val3=Data(val1=1456,val2=val-1789)),p3=MyBuchOfData(val1=23/03/2010 00:00:00,val2=true,val3=Data(val1=1789,val2=val-1123))", actual);
    }
}
